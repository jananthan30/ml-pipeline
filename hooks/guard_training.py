...
def analyse(text: str) -> dict[str, str | None]:
    ...
    found: dict[str, str | None] = {"model": None, "transformer": None, "fit_on_test": None}
...
def gate_state(markdown: str) -> dict[str, bool]:
    ...
    state = {"A": False, "B": False, "C": False, "D": False, "override": False}
...
def main() -> int:
    try:
        ...
        if ".fit" not in text and not TRAIN_API.search(text):
